...
crawl_dst = list()
crawl_dst.append("TrafficAnalysis/Dataset/closew_defense/top100/tamaraw_no_obfuscate_" + sys.argv[1] + "/")

#open world
crawl_dst.append("TrafficAnalysis/Dataset/openw_defense/non_monitor_0-500/tamaraw_no_obfuscate_" + sys.argv[1] + "/")
crawl_dst.append("TrafficAnalysis/Dataset/openw_defense/non_monitor_500-1500/tamaraw_no_obfuscate_" + sys.argv[1] + "/")
crawl_dst.append("TrafficAnalysis/Dataset/openw_defense/non_monitor_1500-2000/tamaraw_no_obfuscate_" + sys.argv[1] + "/")
# closd world
