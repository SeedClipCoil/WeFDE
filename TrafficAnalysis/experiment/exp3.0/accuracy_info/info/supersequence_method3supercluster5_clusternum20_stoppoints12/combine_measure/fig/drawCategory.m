...
for i = fnumber
    path = strcat('../jobrecord/JobRecord_buflo_10_category', int2str(category), '_topn', int2str(i), '_bstrap0', '.mat');
...
for i = fnumber
    for j = 1:bstrap
        path = strcat('../jobrecord/JobRecord_buflo_10_category', int2str(category), '_topn', int2str(i), '_bstrap', int2str(j), '.mat');
