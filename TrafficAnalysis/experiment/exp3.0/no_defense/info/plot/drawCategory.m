...
prior_path = strcat('../', exp_tag, '/combine_measure/jobrecord/prior.mat');
...
for i = fnumber
    path = strcat('../',exp_tag, '/combine_measure/jobrecord/', exp_tag, '_category', int2str(category), '_topn', int2str(i), '_bstrap0', '.mat');
