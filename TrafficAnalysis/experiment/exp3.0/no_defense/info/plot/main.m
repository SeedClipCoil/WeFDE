...
plotArg_100 = containers.Map();
plotArg_100('marker') = 's';
plotArg_100('color') = 'r';
...
%figure;
subplot(3,5,i);
res1 = drawCategory('top100',i, plotArg_100);
hold on;
res2 = drawCategory('top1000',i, plotArg_1000);
res3 = drawCategory('top2000', i, plotArg_2000);
hold off;
title(tag{i}, 'FontSize', 14);

if i == 1
    % add legend
    lg = legend([res1, res2, res3], 'top100', 'top1000', 'top2000', 'Location', 'southeast');
    set(lg, 'FontSize', 10);
end
if i == 6
