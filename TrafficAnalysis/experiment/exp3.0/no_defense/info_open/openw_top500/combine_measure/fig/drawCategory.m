...
prior_path = strcat('../jobrecord/', tag, '_prior.mat');
...
for i = fnumber
    path = strcat('../jobrecord/JobRecord_', tag, '_category', int2str(category), '_topn', int2str(i), '_bstrap0', '.mat');
...
for i = fnumber
    for j = 1:bstrap
        path = strcat('../jobrecord/JobRecord_', tag, '_category', int2str(category), '_topn', int2str(i), '_bstrap', int2str(j), '.mat');
